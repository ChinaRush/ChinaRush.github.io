This blog is based on the templates of an excellent font-engineer
## 使用
...
```
# Site settings
title: M.Shaw Blog                    # 你的博客网站标题
SEOTitle: M.Shaw 		# SEO 标题
description: "Hey"	   	   # 随便说点，描述一下

# SNS settings      
github_username: M.Shaw     # 你的github账号
...
friends: [
    {
        title: "M.Shaw| Blog",
        href: "https://ChinaRush.github.io/"
    },
    {
        title: "Apple",
...
我的博客标题是 **“M.Shaw”** 但是我想要在搜索的时候显示 **“M.Shaw的博客 | M.Shaw Blog”** ，这个就需要 SEO Title 来定义了。
